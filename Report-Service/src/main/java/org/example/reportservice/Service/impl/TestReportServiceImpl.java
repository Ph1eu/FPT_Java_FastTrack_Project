package org.example.reportservice.Service.impl;
...
public class TestReportServiceImpl {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(TestReportServiceImpl.class);
    @Autowired
